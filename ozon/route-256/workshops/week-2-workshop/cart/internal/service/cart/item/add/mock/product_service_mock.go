...
//go:generate minimock -i week-2-workshop/cart/internal/service/cart/item/add.productService -o ./cart/internal/service/cart/item/add/mock/product_service_mock.go -n ProductServiceMock
