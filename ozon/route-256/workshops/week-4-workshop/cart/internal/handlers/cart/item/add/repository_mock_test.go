...
//go:generate minimock -i week-4-workshop/cart/internal/handlers/cart/item/add.repository -o ./cart/internal/handlers/cart/item/add/repository_mock_test.go -n RepositoryMock
