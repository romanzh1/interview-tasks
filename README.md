...
### Common-tasks
В данной директории описаны общие задачи, которые где-либо встречались, а также вопросы из опросников по вакансиям
и технические вопросы с HR собеседований

### Statistics
В данной директории описаны: статистика прохождения интервью в каждом заходе, а также некоторые особенности.

### Nightmare
В данной директории перечислены задачи, которые не несут большой пользы, либо же безумные тестовые задания или задания
с оставшимся не известным условием. Кому интересно - Welcome
